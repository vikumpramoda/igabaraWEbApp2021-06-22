...
const PinkAppointmentForm = (props) => {
  ...
  const submitHandler = event => {
    ...
    if (validateInput()) {
      axios.post(`${baseUrl}/pinkreservations`, input)
        .then(response => {
      ...
      const paperStyle={padding :20,height:'75vh',width:600, margin:"20px auto", backgroundColor:'#ffe6ea'}
  return (
    <div>
...
export default withRouter(PinkAppointmentForm);